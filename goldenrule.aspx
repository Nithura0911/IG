<%@ Page language="c#" Inherits="Eschool.Resultsdisplay" CodeFile="goldenrule.aspx.cs" %>
							...
							<tr>
								...
								<td align="center">
									...
									<TABLE class="maintblcls" id="Table2" cellPadding="2" align="center">
										...
										<TR class="tdcls">
											<TD align="right" class="style1"><asp:label id="lblcourseid" text="S NO" 
                                                    Runat="server"></asp:label></TD>
											<TD class="style1"><asp:textbox id="txtstudid" runat="server" AutoPostBack="True" 
                                                    CssClass="txtcls" Width="208px"></asp:textbox></TD>
										</TR>
										<TR class="tdcls">
											<TD align="right" class="style2"><asp:label id="Label2" text="Golden Rule" 
                                                    Runat="server"></asp:label></TD>
