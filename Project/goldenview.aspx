...
<%@ Page language="c#" Inherits="Eschool.StudentMaterialDownloads" CodeFile="goldenview.aspx.cs" %>
							...
							<TR>
								<TD class="tdcls" colspan="2">
									<TABLE class="maintblcls" cellSpacing="0" cellPadding="0" align="center" border="0" DESIGNTIMEDRAGDROP="1607">
										<TR class="tdcls">
											<TD class="headingtext" align="center" colSpan="2">&nbsp;Golden Rule</TD>
										</TR>
										<TR class="tdcls">
											<TD align="center" colSpan="2">
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Golden_Rule" HeaderText="Golden_Rule" 
                                                            SortExpression="Golden_Rule" />
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                    ...
                                                    SelectCommand="SELECT * FROM [rules]"></asp:SqlDataSource>
                                            </TD>
										</TR>
										<TR class="tdcls">
											<TD align="center" colSpan="2">
