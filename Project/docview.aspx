...
<%@ Page language="c#" Inherits="Eschool.StudentMaterialDownloads" CodeFile="docview.aspx.cs" %>
						...
						<div id="button">
							<ul>
								<li>
								 ...
								 <li>
									<A title="Go to style sheet" tabIndex="11" href="">Doc</A></li>
								<li>
							...
							<TR>
								<TD class="tdcls" colspan="2">
									<TABLE class="maintblcls" cellSpacing="0" cellPadding="0" align="center" border="0" DESIGNTIMEDRAGDROP="1607">
										<TR class="tdcls">
											<TD class="headingtext" align="center" colSpan="2">&nbsp;Developement Observation Card</TD>
										</TR>
										<TR class="tdcls">
										...
										<TR class="tdcls">
											<TD align="center" colSpan="2">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                    ...
                                                    SelectCommand="SELECT * FROM [doc]"></asp:SqlDataSource>
                                            </TD>
										</TR>
										<TR class="tdcls">
