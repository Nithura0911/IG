...
<%@ Page language="c#" Inherits="Eschool.StudentMaterialDownloads" CodeFile="vacc.aspx.cs" %>
						...
						<div id="button">
							<ul>
								<li>
								 ...
								 <li>
									<A title="Go to style sheet" tabIndex="11" href="StudentMaterialDownloads.aspx">Doc</A></li>
								<li>
								...
								<li>
									<A title="Go to the Tutorials" tabIndex="30" href="StudentPaymentDetails.aspx">Vaccination Charts</A></li>
								<LI>
								...
								<li>
									<A title="Go to the Tutorials" tabIndex="30" href="">Common Problems</A></li>
								<LI>
									<A title="Go to the Tools" tabIndex="35" href="">Behavioral Symptoms</A>
								</LI>
							</ul>
						</div>
						<br>
									...
									<TABLE class="maintblcls" cellSpacing="0" cellPadding="0" align="center" border="0" DESIGNTIMEDRAGDROP="1607">
										...
										<TR class="tdcls">
											<TD align="center" colSpan="2">
												<asp:Image ID="Image1" runat="server" Height="394px" 
                                                    ImageUrl="~/Image/vacci.png" Width="609px" />
                                            </TD>
										</TR>
										<TR class="tdcls">
